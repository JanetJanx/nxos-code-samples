...
def main():
    ...
    with manager.connect(host = device["address"],
        ...
        netconf_response = m.get(('subtree', bgp_mode_filter))
        # Parse the XML response
        xml_data = netconf_response.data_ele
        mode = xml_data.find(".//{http://cisco.com/ns/yang/cisco-nx-os-device}mode").text


        print("The BGP router mode for {} is {}".format(device["address"], mode))
